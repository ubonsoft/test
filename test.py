...
#V1 'EFr2AaJ7SUAfNixW6H52.KzxQmBpV2OJKI/qF7B0hGG.wALv9VavUIFR7b6568csu3NMOQn9acQpj3wagj1rj7Q='


#V2 'EFwNNIwDl8ZaMEz1mWm7.fgBom+VjSmbIAwIo3EAGHW.6lHEXccvbLthF+yy8NRAsqNznFHVX/OhcJCvXYH0Z20='

#nadya = LINE()
nadya = LINE('mybot.read.v1@gmail.com','@mybot517246666')
#nadya = LINE("EFt2OPsEaRDmIPYE0kQ9.sFTc0mEvwYe6PHijZgnPgq.o+N2jWC561NyvheF709jcgPvVclbAdR5E2cQ9WBsOI8=")


# H V4 = EG8glG4i6HM7ulaVLTu9.sFTc0mEvwYe6PHijZgnPgq.iuB8B7vUG4DrH4knLIpsPm/Wmv4BM5GYm3rOG5ACzgs=

# nadya = LINE("EG8glG4i6HM7ulaVLTu9.sFTc0mEvwYe6PHijZgnPgq.iuB8B7vUG4DrH4knLIpsPm/Wmv4BM5GYm3rOG5ACzgs=")



# JET V3 : EGHWa9C9CFtO7zp6inEc.Pt0819v3bNjfgx20E3AxJa.H8KAmORhOyzx/ePfugSrTiXEIfQgqfvkCWEXArn9xgI=
#nadya = LINE("EGHWa9C9CFtO7zp6inEc.Pt0819v3bNjfgx20E3AxJa.H8KAmORhOyzx/ePfugSrTiXEIfQgqfvkCWEXArn9xgI=")
        ...
        if op.type == 26:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == 'help':
                    ...
                    nadya.sendContact(to, "u3190587d2822a788a707dbe2b6192d21")
                ...
                # ==================== function ======================
                    group_invit = nadya.getGroupIdsInvited()
                    group_join = nadya.getGroupIdsJoined()
                    group_frn = nadya.getAllContactIds()

                    len_invit = len(group_invit)
                    len_join = len(group_join)
                    len_frn = len(group_frn)

                    # print ('______________________________',len_invit,len_join,len_frn)
                    nadyaProfile.statusMessage = "เข้ากลุ่ม: "+str(len_join)+" กำลังเชิญ: "+str(len_invit)+" เพื่อน: "+str(len_frn)
                ...
                #==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u3190587d2822a788a707dbe2b6192d21"
